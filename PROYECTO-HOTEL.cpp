...
void fun_registrarPersona(string cedula,int dia, int mes, int anio, int hora, int min,Persona *&pcabPer,Persona *&pfinPer){
	...
	do{
		...
		gotoxy(24,19);cout<<"A�o: ";cin>>nuevaPersona->anio1;
	...
	do{
		...
		gotoxy(24,25);cout<<"A�o: ";cin>>nuevaPersona->anio2;	
 ...
 void reloj()
{
	...
	//Formato=dia/mes/a�o     el mes comienza en 0 por eso se suma +1  y y el a�o se le suma 1900 sino saldria 118
